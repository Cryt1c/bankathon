angular.module('starter.controllers', [])
  ...
  .controller('DashCtrl', function ($scope, $state, $ionicPopup, $ionicHistory, $ionicSlideBoxDelegate, $window, Amount, Stats) {
    ...
    $scope.showRequest = function () {
      ...
      var myRequest = $ionicPopup.show({
        ...
        buttons: [
          ...
          {
            text: '<b>OK</b>',
            type: 'button-positive requestButton',
            onTap: function (e) {
    ...
    $scope.changeButton = function () {
      if ($scope.data.message) {
        var button = $window.document.getElementsByClassName("requestButton")[0];
        console.log(button.style.display);
        button.style["display"] = "inline !important";
        console.log(button.style.display);
      }
      else {
        $window.document.getElementsByClassName("requestButton")[0].style.display = "none !important";
        console.log("nodata");
      }
    };
